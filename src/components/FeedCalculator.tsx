...
const FeedCalculator: React.FC = () => {
  ...
  const handleAddNutrition = () => {
    ...
    // 重複チェック
    const nutritionKey = newNutritionName.toLowerCase().replace(/\s+/g, '_');
    if (Object.keys(visibleNutritions).includes(nutritionKey) || 
        Object.keys(customNutritions).includes(nutritionKey)) {
            ...
            <Paper className="p-4">
              <div className="flex justify-between items-center mb-4">
                ...
                <Button
                  ...
                  onClick={() => {
                    console.log('Toggle competitors view:', !showCompetitors);
                    toggleCompetitorsView();
                  }}
                >
